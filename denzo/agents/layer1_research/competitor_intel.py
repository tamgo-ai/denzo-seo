...
# ── Geo proximity data — nearby cities for common Southern California markets ──
# Each city maps to a list of nearby cities within ~35 miles.
# Extend this dict for other metros as needed.
_NEARBY_CITIES: dict[str, list[str]] = {
    # San Fernando Valley / LA
    "north hollywood": ["burbank", "glendale", "pasadena", "studio city",
                        "van nuys", "sherman oaks", "woodland hills", "encino",
                        "reseda", "chatsworth", "canoga park", "panorama city",
                        "toluca lake", "los angeles", "santa monica"],
    "burbank":         ["north hollywood", "glendale", "pasadena", "studio city",
                        "los angeles", "toluca lake"],
    "glendale":        ["north hollywood", "burbank", "pasadena", "los angeles",
                        "la crescenta", "montrose"],
    "los angeles":     ["north hollywood", "burbank", "glendale", "pasadena",
                        "santa monica", "culver city", "torrance", "long beach",
                        "inglewood", "hawthorne"],
    # Inland Empire
    "ontario":         ["rancho cucamonga", "pomona", "chino", "riverside",
                        "corona", "fontana", "rialto", "upland", "montclair",
                        "claremont", "chino hills", "san bernardino"],
    "rancho cucamonga": ["ontario", "upland", "fontana", "rialto", "claremont",
                         "montclair", "chino", "pomona"],
    "riverside":       ["corona", "ontario", "san bernardino", "moreno valley",
                        "perris", "norco", "jurupa valley"],
    "corona":          ["riverside", "ontario", "chino hills", "norco",
                        "anaheim hills", "yorba linda"],
    # Orange County
    "anaheim":         ["garden grove", "orange", "fullerton", "santa ana",
                        "buena park", "yorba linda", "placentia"],
    "santa ana":       ["anaheim", "garden grove", "orange", "irvine",
                        "costa mesa", "fountain valley"],
    # South Bay
    "torrance":        ["gardena", "hawthorne", "redondo beach", "hermosa beach",
                        "manhattan beach", "carson", "lomita", "long beach"],
    "gardena":         ["torrance", "hawthorne", "inglewood", "compton",
                        "carson", "los angeles"],
    # Bakersfield
    "bakersfield":     ["delano", "tehachapi", "shafter", "wasco"],
    # Whittier / SGV
